<template>
  <div class="page-container home-page">
    ...
    <div v-if="activePromotions.length > 0" class="promotion-section">
      ...
      <div class="promotion-list">
        ...
        >
          ...
          <div class="promotion-info">
            ...
            <div v-if="promotion.discountType === 'percentage'" class="promotion-discount">
              {{ promotion.discountValue }}折
            </div>
            <div v-else class="promotion-discount">减{{ promotion.discountValue }}元</div>
          </div>
        </div>
      </div>
    </div>
