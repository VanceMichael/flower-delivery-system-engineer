  ...
  <div class="product-detail-page">
    ...
    <div class="product-info-section">
      ...
      <div class="product-tags">
        <van-tag v-for="tag in product.tags" :key="tag" type="primary" size="mini">
          {{ tag }}
        </van-tag>
      </div>
    </div>

    <van-cell-group v-if="product.materials?.length > 0" inset class="material-group">
      <van-cell title="花材搭配">
        <template #default>
          <div class="materials">
    ...
    <van-cell-group v-if="product.customConfig?.isCustomizable" inset class="custom-group">
        ...
        >
          ...
          <div class="choice-list">
            ...
            >
              ...
              <span v-if="choice.price > 0" class="choice-price">+¥{{ choice.price }}</span>
            </div>
          </div>
        </div>
      </div>
    ...
    >
      ...
      <div class="greeting-cards">
        ...
        >
          ...
          <div v-if="card.isPremium && card.price > 0" class="card-price">+¥{{ card.price }}</div>
        </div>
      </div>
